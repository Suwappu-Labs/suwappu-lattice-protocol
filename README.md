...
[![Whitepaper](https://img.shields.io/badge/whitepaper-0.2.5-informational)](docs/WHITEPAPER.md)
[![Formal](https://img.shields.io/badge/Lean_4-73_theorems-9cf)](formal/lean/README.md)
...
> ([whitepaper](docs/WHITEPAPER.md)) is at 0.2.5 — a public draft issued for
...
**Lean 4** ([`formal/lean/`](formal/lean/README.md)) — 73 audited theorems, no
...
│
├── formal/lean/                # Lean 4 machine-checked proofs (73 theorems)
...
|----------|-------------|
| [Whitepaper](docs/WHITEPAPER.md) | Full protocol specification (v0.2.5, public draft for comment) |
...
| Lean 4 theorems (machine-checked, `sorry`-free) | 73 |
