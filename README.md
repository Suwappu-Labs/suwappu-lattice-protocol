...
[![Whitepaper](https://img.shields.io/badge/whitepaper-0.2.8-informational)](docs/WHITEPAPER.md)
...
> ([whitepaper](docs/WHITEPAPER.md)) is at 0.2.8 — a public draft issued for
...
|----------|-------------|
| [Whitepaper](docs/WHITEPAPER.md) | Full protocol specification (v0.2.8, public draft for comment) |
