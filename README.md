...
[![Whitepaper](https://img.shields.io/badge/whitepaper-0.2.6-informational)](docs/WHITEPAPER.md)
[![Formal](https://img.shields.io/badge/Lean_4-82_theorems-9cf)](formal/lean/README.md)
...
> ([whitepaper](docs/WHITEPAPER.md)) is at 0.2.6 — a public draft issued for
...
**Lean 4** ([`formal/lean/`](formal/lean/README.md)) — 82 audited theorems, no
...
│
├── formal/lean/                # Lean 4 machine-checked proofs (82 theorems)
...
|----------|-------------|
| [Whitepaper](docs/WHITEPAPER.md) | Full protocol specification (v0.2.6, public draft for comment) |
...
| Lean 4 theorems (machine-checked, `sorry`-free) | 82 |
