...
[![Tests](https://img.shields.io/badge/tests-4,066_passing-brightgreen)]()
[![Python](https://img.shields.io/badge/python-3.10+-blue)]()
[![License](https://img.shields.io/badge/license-MIT-green)]()
[![SDK](https://img.shields.io/badge/SDK-3.0.0-orange)]()
[![Whitepaper](https://img.shields.io/badge/whitepaper-0.2.10-informational)](docs/WHITEPAPER.md)
[![Formal](https://img.shields.io/badge/Lean_4-90_theorems-9cf)](formal/lean/README.md)
...
> ([whitepaper](docs/WHITEPAPER.md)) is at 0.2.10 — a public draft issued for
...
**Lean 4** ([`formal/lean/`](formal/lean/README.md)) — 90 audited theorems, no
...
│
├── formal/lean/                # Lean 4 machine-checked proofs (90 theorems)
...
|----------|-------------|
| [Whitepaper](docs/WHITEPAPER.md) | Full protocol specification (v0.2.10, public draft for comment) |
...
| Lean 4 theorems (machine-checked, `sorry`-free) | 90 |
