...
- **Smart contract integration** — underway. LTPAnchorRegistry (UUPS proxy) and LTPMultiSig are live on Base Sepolia (`84532`) and Ethereum Sepolia (`11155111`); see [`DEPLOYED_CONTRACTS.md`](DEPLOYED_CONTRACTS.md)
